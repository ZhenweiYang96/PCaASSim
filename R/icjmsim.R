...
#'  \item \code{PSAValue} - transformation of PSA value (ng/ml), \eqn{\log_2(\text{PSA} + 1)}
...
#'  \item \code{density} - baseline PSA density (\eqn{\text{ng}/\text{ml}^2}) in log transformation, \eqn{\log(\text{PSA density})}
